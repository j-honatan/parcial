...
from copy import deepcopy # Importa la función deepcopy para copiar listas
from colorama import Fore, Back, Style  # Importa Colorama para colorear la salida en la terminal
...
#es un algoritmo de cálculo de distancia
